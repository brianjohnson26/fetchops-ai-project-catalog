  ...
  return (
    <div className="grid" style={{ gridTemplateColumns: "1fr" }}>
      ...
      <div className="stats-grid">
        <div className="card">
          <div className="text-lg font-bold">Total projects</div>
          <div className="text-3xl font-semibold">{s.projectCount}</div>
        </div>
        <div className="card">
          <div className="text-lg font-bold">Weekly hours saved</div>
          <div className="text-3xl font-semibold">{s.totalHours}</div>
        </div>
        <div className="card">
          <div className="text-lg font-bold">Project Owners</div>
          <div className="text-3xl font-semibold">{s.distinctOwners}</div>
        </div>
        <div className="card">
          <div className="text-lg font-bold">Top tools</div>
          <ul className="mt-1">
